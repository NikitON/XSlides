...
public class Youtube {
    ...
    private String getInfoData() {
        String data = "";
        try {
            URL yt = new URL("http://youtube.com/get_video_info?&video_id=" + videoID
    ...
    public HashMap<String, String> getLinks() throws UnsupportedEncodingException {
        ...
        for (String u : urls) {
            if (!u.isEmpty()) {
                ...
                u = u.replaceAll("%25", "%").replaceAll("%26", "&").replaceAll("%3F", "?").replaceAll("%2F", "/")
    ...
    public String getExt(String fmtList) {
        if (fmtList.equals("5") || fmtList.equals("34") || fmtList.equals("35")) {
            return ".flv";
        }
        if (fmtList.equals("17")) {
            return ".3gp";
        }
        if (fmtList.equals("18") || fmtList.equals("22") || fmtList.equals("37")) {
            return ".mp4";
        }
        if (fmtList.equals("43") || fmtList.equals("44") || fmtList.equals("45")) {
            return ".WEBM";
        }
        return null;
    }
